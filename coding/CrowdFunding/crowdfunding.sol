...
contract crowdFunding{
    ...
    uint public numRequests; //Mapping doesn't use or increment indexes automatically (like array does)
    ...
    function getRefund() public{
        require(block.timestamp > deadline && raisedAmount < goal, "Refund requests aren't open!");
        require(contributors[msg.sender] > 0, "Your are not eligible to request refund!");
